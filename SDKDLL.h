...
extern "C" {
	...
	@ Variable:
	@ Returns: bool: true plugged infalse not plugged in
	@ Note:
	@*/
	...
	@ Detail: set control over devices LED
	@ Variable: bool bEnable: true Controlled by SWfalse Controlled by FW
	@ Returns: bool: true Successfalse Fail
	@ Note:
	@*/
	...
	@ Variable: COLOR_MATRIX colorMatrix:structurefill up RGB value according to LED Table
	@ Returns: bool: true Successfalse Fail
	@ Note:
	@*/
	...
	@ Variable: KEY_CALLBACK callback call back setupplease reference the def of KEY_CALLBACK
	@ Returns: none
	@ Note:
	@*/
